#ifndef LCD_H
#define LCD_H LCD_H 	//!< protects this file from beeing double included
namespace LCD {
    /*
     * lc7981.h
     *
...
#define LCD_CTRL 	PORTD		//!< Port used for control signals
   ...
   #define LCD_RS			PD7		//!< Register-Select Pin of the Display
   #define LCD_RW			PD6		//!< Read-Write-select Pin
   #define LCD_EN			PD5		//!< Strobe Pin



   #define LCD_DATA		PORTC	//!< Port used for data
   #define LCD_DATA_PIN 	PINC	//!< Port used for reading the data
   ...
   #define PIXEL_OFF 0					//!< see lcd_plot_pixel
    ...
    extern char lcd_mode; 		//!< Currently used mode, can be text or graphic.
    extern char lcd_curline;	//!< Current line. Used for scrolling in text mode.
...
static inline char lcd_read_byte(uint16_t pos);
